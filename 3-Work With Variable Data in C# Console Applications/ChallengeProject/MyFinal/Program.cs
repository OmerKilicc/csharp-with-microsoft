...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] dogCharacteristics = new string[100];
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    {
                        int count = 0;
                        string dogCharacteristic = dogCharacteristics[count];
                    ...
                    foreach (var characteristic in dogCharacteristics)
                    {
                        if (dogDescription.Contains(characteristic))
                        {
                            ...
                            Console.WriteLine($"\nOur dog {ourAnimals[i, 3]} matches your search for {characteristic}");
