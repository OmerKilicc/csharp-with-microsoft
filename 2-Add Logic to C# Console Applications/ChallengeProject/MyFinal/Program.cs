...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                //Skip over any animal in the ourAnimals array 
                //when the value of pet ID is set to the default value.
                if (ourAnimals[i, 0] == "ID #: ")
                    continue;

                //Display the pet ID value and prompt the user for an updated data 
                //value if ourAnimals array data is missing or incomplete.

                //Ensure that a valid numeric value is assigned to animalAge 
                //for all animals in the ourAnimals array that have assigned data.
                ...
                do
                {
                    ...
                    {
                        isValidNumber = true;
                        ourAnimals[i, 2] = ageOfAnimal.ToString();
                    }

                } while (ourAnimals[i, 2] == "?" || isValidNumber == false);


                //Ensure that a valid string is assigned to animalPhysicalDescription 
                //for all animals in the ourAnimals array that have assigned data.
                ...
                do
                {
                    ...
                    bool isNumeric = int.TryParse(animalDescription, out _);

                    if (!string.IsNullOrEmpty(animalDescription) && !isNumeric)
                    {
                        isValidDescription = true;
                        ourAnimals[i, 4] = animalDescription;
                    }

                } while (ourAnimals[i, 4] == "tbd" || isValidDescription == false);
            }
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                } while (ourAnimals[i, 3] == "tbd" || isValidNick);


                bool isValidPersonality = false;
                do
                {
                ...
                } while (ourAnimals[i, 5] == "tbd" || isValidPersonality);
            }
